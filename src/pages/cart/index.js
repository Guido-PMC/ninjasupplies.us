                        ...
                        <div className="row justify-content-end">
                           <div className="col-md-5">
                              <div className="cart-page-total">
                                 <h2>Cart totals</h2>
                                 <ul className="mb-20">
                                    <li>Subtotal <span>{total >= 100000 ? `$${parseFloat(total).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,').replace('.','|').replace(',','.').replace('|',',')}` : `$${total}`}</span></li>
                                    <li>Total <span>{total >= 100000 ? `$${parseFloat(total).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,').replace('.','|').replace(',','.').replace('|',',')}` : `$${total}`}</span></li>
                                 </ul>
                                 <Link href="/checkout">
